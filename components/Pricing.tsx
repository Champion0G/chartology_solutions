...
const plans = [
    {
        name: 'Pay At Once',
        price: '₹29,999',
        period: 'one-time (save 25%)',
        badge: 'Best Value',
        features: [
            'Duration: 6 Months (Lifetime Access)',
            'What\'s Included: All 10 Modules',
            'Support: 1-on-1 RM + Direct Chat',
            'Community: Lifetime Discord Access',
            'Mentorship: Group Q&As + Portfolio Review',
            'Bonus: Excel Trading Journal Sheet',
        ],
        cta: 'Enroll Now',
    },
    {
